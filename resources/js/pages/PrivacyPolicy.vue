...
<template>
    ...
    <div class="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] dark:bg-[#0a0a0a] lg:justify-center lg:p-8">
        ...
        <div class="duration-750 starting:opacity-0 flex w-full items-center justify-center opacity-100 transition-opacity lg:grow">
            <main class="w-full max-w-none overflow-hidden rounded-lg">
                <div
                    class="rounded-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] lg:p-20"
                >
                    <h1 class="mb-6 text-center text-[28px] font-extrabold tracking-tight lg:text-[34px]">Política de Privacidad</h1>
                    <p class="mb-4 text-[#706f6c] dark:text-[#A1A09A]">
                        Esta Política de Privacidad describe cómo la Universidad de Huánuco (en adelante, «UDH»), en su calidad de responsable del tratamiento,
                        recopila, utiliza, conserva y protege los datos personales de salud procesados por el sistema de monitoreo de gestantes, que integra
                        información del Huawei Health Kit y del reloj Huawei Watch D2. Esta política cumple la Ley N.º 29733 – Ley de Protección de Datos
                        Personales del Perú y es compatible con los requisitos de claridad y transparencia de Huawei Health Kit.
                    </p>

                    <section class="space-y-6">
                        <div>
                            <h2 class="mb-1 text-[16px] font-medium">1. Responsable del tratamiento</h2>
                            <p>
                                Responsable: <strong>Universidad de Huánuco (UDH)</strong>.<br />
                                Finalidad institucional: prevención y/o detección temprana de <strong>preeclampsia</strong> y otras complicaciones del embarazo mediante
                                monitoreo continuo de indicadores de salud.
                            </p>
                        </div>

                        <div>
                            <h2 class="mb-1 text-[16px] font-medium">2. Datos personales recopilados</h2>
                            <p>El sistema procesa los siguientes datos, previa autorización expresa de la usuaria gestante:</p>
                            <ul class="ml-4 list-disc space-y-1">
                                <li><strong>Actividad física</strong>: pasos, detalles de muestreo de pasos, total de pasos diarios, horas activas, duración de actividades de intensidad media y alta, calorías activas y resúmenes diarios.</li>
                                <li><strong>Composición corporal</strong>: peso, grasa corporal, IMC, talla, masa muscular, masa de agua y métricas relacionadas.</li>
                                <li><strong>Signos vitales</strong>: frecuencia cardiaca (dinámica y en reposo), presión arterial (sistólica, diastólica y pulso), saturación de oxígeno (SpO2), temperatura corporal y de piel.</li>
                                <li><strong>Otros indicadores de salud</strong>: estrés (puntaje y nivel), sueño (etapas, registros y estadísticas), glucosa en sangre, estado emocional.</li>
                                <li><strong>Históricos</strong>: lecturas semanales y mensuales autorizadas por la usuaria.</li>
                                <li><strong>Datos manuales</strong>: síntomas ingresados (p. ej., dolor de cabeza, visión borrosa, hinchazón).</li>
                            </ul>
                            <p class="mt-2">La captura puede provenir de la app móvil, dispositivos conectados (Huawei Watch D2) y la sincronización con <strong>Huawei Health Kit</strong>.</p>
                        </div>

                        <div>
                            <h2 class="mb-1 text-[16px] font-medium">3. Finalidades del tratamiento</h2>
                            <ul class="ml-4 list-disc space-y-1">
                                <li>Visualizar presión arterial, frecuencia cardiaca, SpO2, sueño, estrés y actividad física en tiempo real.</li>
                                <li>Sincronizar y subir datos a la <strong>nube de Huawei Health</strong> y almacenarlos en la <strong>base de datos del backend</strong> (hosting privado VPN con dominio institucional).</li>
                                <li>Clasificar y conservar información por día, semana, mes y año.</li>
                                <li>Generar alertas y notificaciones ante valores anormales o patrones de riesgo.</li>
                                <li>Integrar datos en un <strong>panel web para personal médico autorizado</strong> y en la <strong>app móvil para la gestante</strong>.</li>
                            </ul>
                        </div>

                        <div>
                            <h2 class="mb-1 text-[16px] font-medium">4. Base legal</h2>
                            <p>
                                El tratamiento se sustenta en el <strong>consentimiento libre, previo, expreso e informado</strong> de la usuaria (Ley N.º 29733 y su Reglamento),
                                así como en el interés legítimo de brindar un servicio de salud digital de apoyo al cuidado prenatal, respetando siempre
                                los principios de legalidad, proporcionalidad, finalidad y seguridad.
                            </p>
                        </div>

                        <div>
                            <h2 class="mb-1 text-[16px] font-medium">5. Destinatarios y compartición</h2>
                            <ul class="ml-4 list-disc space-y-1">
                                <li><strong>Huawei Health Cloud</strong> (proveedor tecnológico para sincronización y almacenamiento en la nube).</li>
                                <li><strong>Personal médico autorizado</strong> de la UDH, con acceso restringido para fines estrictamente asistenciales.</li>
                                <li><strong>No</strong> se comparten datos con terceros no autorizados ni con fines comerciales.</li>
                            </ul>
                        </div>

                        <div>
                            <h2 class="mb-1 text-[16px] font-medium">6. Transferencias internacionales</h2>
                            <p>
                                La sincronización con <strong>Huawei Health Cloud</strong> puede implicar transferencias internacionales de datos. Estas se realizan bajo
                                medidas contractuales y técnicas adecuadas provistas por Huawei y aceptadas por la usuaria al autorizar la integración con
                                Health Kit. UDH exige a sus proveedores estándares de seguridad y confidencialidad equivalentes o superiores a los nacionales.
                            </p>
                        </div>

                        <div>
                            <h2 class="mb-1 text-[16px] font-medium">7. Conservación de datos</h2>
                            <p>
                                Los datos se conservan <strong>hasta que la usuaria solicite su eliminación</strong> o hasta que cese la finalidad que motivó su tratamiento,
                                aplicando criterios de minimización y retención acorde a normativa de salud y protección de datos.
                            </p>
                        </div>

                        <div>
                            <h2 class="mb-1 text-[16px] font-medium">8. Seguridad y confidencialidad</h2>
                            <ul class="ml-4 list-disc space-y-1">
                                <li>Controles de acceso basados en roles y autenticación para personal médico autorizado.</li>
                                <li>Transmisión y almacenamiento mediante canales seguros; cifrado según mejores prácticas cuando corresponda.</li>
                                <li>Registro de accesos y auditoría de eventos relevantes.</li>
                                <li>Hosting en infraestructura privada (VPN) con dominio institucional para el backend.</li>
                                <li>Evaluaciones periódicas de seguridad y cumplimiento.</li>
                            </ul>
                        </div>

                        <div>
                            <h2 class="mb-1 text-[16px] font-medium">9. Derechos ARCO y cómo ejercerlos</h2>
                            <p>
                                La usuaria puede ejercer sus derechos de <strong>acceso, rectificación, cancelación y oposición (ARCO)</strong>, así como solicitar
                                la <strong>revocatoria del consentimiento</strong> y la <strong>eliminación</strong> de sus datos en cualquier momento.
                            </p>
                            <p class="mt-2">
                                Para ejercerlos, comuníquese al correo de privacidad indicado, adjuntando su identificación y la solicitud específica. UDH responderá
                                dentro de los plazos establecidos por la normativa aplicable.
                            </p>
                        </div>

                        <div>
                            <h2 class="mb-1 text-[16px] font-medium">10. Contacto de privacidad</h2>
                            <p>
                                Correo: <a href="mailto:2021110349@udh.edu.pe" class="text-[#f53003] underline underline-offset-4 dark:text-[#FF4433]">2021110349@udh.edu.pe</a>
                            </p>
                        </div>

                        <div>
                            <h2 class="mb-1 text-[16px] font-medium">11. Actualizaciones de la política</h2>
                            <p>
                                UDH podrá actualizar esta Política para reflejar cambios normativos, operativos o de integración tecnológica (incluyendo requisitos
                                de Huawei Health Kit). Las modificaciones serán publicadas en este mismo apartado, indicando la fecha de última actualización.
                            </p>
                        </div>

                        <div class="rounded-sm border border-[#e3e3e0] bg-[#FDFDFC] p-3 text-[12px] text-[#706f6c] dark:border-[#3E3E3A] dark:bg-[#161615] dark:text-[#A1A09A]">
                            <p class="mb-1"><strong>Nota sobre Huawei Health Kit:</strong> Esta integración se realiza conforme a las políticas y lineamientos de Huawei para desarrolladores. La usuaria mantiene el control de sus permisos y puede revocar la autorización desde la aplicación.</p>
                            <p><strong>Última actualización:</strong> 07/10/2025</p>
                        </div>
                    </section>
                </div>
                <div
