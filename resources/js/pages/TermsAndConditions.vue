    ...
    <div class="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] dark:bg-[#0a0a0a] lg:justify-center lg:p-8">
        ...
        <div class="duration-750 starting:opacity-0 flex w-full items-center justify-center opacity-100 transition-opacity lg:grow">
            <main class="w-full max-w-none overflow-hidden rounded-lg">
                ...
                >
                    <h1 class="mb-6 text-center text-[28px] font-extrabold tracking-tight lg:text-[34px]">Términos y Condiciones</h1>
                    <p class="mb-4 text-[#706f6c] dark:text-[#A1A09A]">
                        Estos Términos y Condiciones regulan el acceso y uso del sistema de monitoreo de gestantes de la Universidad de Huánuco (en adelante, «UDH»).
                        Al registrarte, acceder o usar el sistema (web y/o app móvil), declaras haber leído y aceptado íntegramente estos términos. Si no estás de acuerdo,
                        debes abstenerte de utilizar el servicio.
                    </p>

                    <section class="space-y-6">
                        <div>
                            <h2 class="mb-1 text-[16px] font-medium">1. Aceptación de los Términos</h2>
                            <p>
                                Al crear una cuenta y/o utilizar el sistema, aceptas cumplir estos Términos y Condiciones y todas las políticas vinculadas,
                                incluyendo nuestra <a :href="route('privacy-policy')" class="text-[#f53003] underline underline-offset-4 dark:text-[#FF4433]" target="_blank">Política de Privacidad</a>.
                            </p>
                        </div>

                        <div>
                            <h2 class="mb-1 text-[16px] font-medium">2. Descripción del Servicio</h2>
                            <p>
                                El sistema permite el registro, visualización y análisis de indicadores de salud de gestantes, así como la generación de alertas
                                y reportes para apoyo al personal médico. Algunas funciones pueden requerir integración con proveedores tecnológicos externos.
                            </p>
                        </div>

                        <div>
                            <h2 class="mb-1 text-[16px] font-medium">3. Cuenta de Usuario</h2>
                            <ul class="ml-4 list-disc space-y-1">
                                <li>Eres responsable de la veracidad de los datos que proporciones y de mantener la confidencialidad de tus credenciales.</li>
                                <li>Debes notificarnos de inmediato ante cualquier uso no autorizado de tu cuenta.</li>
                                <li>UDH puede suspender o cancelar cuentas que incumplan estos términos o comprometan la seguridad del sistema.</li>
                            </ul>
                        </div>

                        <div>
                            <h2 class="mb-1 text-[16px] font-medium">4. Uso Aceptable</h2>
                            <ul class="ml-4 list-disc space-y-1">
                                <li>No realizar actividades que vulneren la ley, los derechos de terceros o la seguridad del sistema.</li>
                                <li>No intentar descompilar, realizar ingeniería inversa o acceder a áreas no autorizadas.</li>
                                <li>No introducir contenido malicioso (malware, spam, o información falsificada).</li>
                            </ul>
                        </div>

                        <div>
                            <h2 class="mb-1 text-[16px] font-medium">5. Datos y Privacidad</h2>
                            <p>
                                El tratamiento de datos personales se rige por la <a :href="route('privacy-policy')" class="text-[#f53003] underline underline-offset-4 dark:text-[#FF4433]" target="_blank">Política de Privacidad</a>.
                                Al usar el sistema, consientes dicho tratamiento conforme a la normativa aplicable.
                            </p>
                        </div>

                        <div>
                            <h2 class="mb-1 text-[16px] font-medium">6. Propiedad Intelectual</h2>
                            <p>
                                El software, interfaces, diseños, logotipos y demás contenidos del sistema son propiedad de UDH o de sus licenciantes y están
                                protegidos por leyes de propiedad intelectual. No se concede licencia distinta a la necesaria para utilizar el servicio.
                            </p>
                        </div>

                        <div>
                            <h2 class="mb-1 text-[16px] font-medium">7. Disponibilidad y Modificaciones</h2>
                            <p>
                                UDH puede actualizar, mejorar, suspender o discontinuar funciones del sistema en cualquier momento para garantizar seguridad,
                                mantenimiento o mejoras. Procuraremos notificar cambios relevantes cuando sea razonable.
                            </p>
                        </div>

                        <div>
                            <h2 class="mb-1 text-[16px] font-medium">8. Limitación de Responsabilidad</h2>
                            <p>
                                En la medida permitida por ley, UDH no será responsable por daños indirectos, incidentales o consecuentes derivados del uso o
                                imposibilidad de uso del sistema. El servicio se proporciona «tal cual» y «según disponibilidad».
                            </p>
                        </div>

                        <div>
                            <h2 class="mb-1 text-[16px] font-medium">9. Indemnización</h2>
                            <p>
                                Te comprometes a indemnizar y mantener indemne a UDH ante reclamaciones de terceros derivadas de tu uso del sistema en
                                contravención de estos términos o de la ley.
                            </p>
                        </div>

                        <div>
                            <h2 class="mb-1 text-[16px] font-medium">10. Terminación</h2>
                            <p>
                                UDH puede suspender o dar por terminado tu acceso si incumples estos términos. Puedes dejar de usar el sistema en cualquier
                                momento. Algunas obligaciones pueden subsistir tras la terminación (p. ej., propiedad intelectual).
                            </p>
                        </div>

                        <div>
                            <h2 class="mb-1 text-[16px] font-medium">11. Ley Aplicable y Jurisdicción</h2>
                            <p>
                                Estos términos se rigen por las leyes de la República del Perú. Cualquier controversia se someterá a los tribunales competentes
                                del territorio peruano.
                            </p>
                        </div>

                        <div>
                            <h2 class="mb-1 text-[16px] font-medium">12. Contacto</h2>
                            <p>
                                Consultas sobre estos términos: <a href="mailto:2021110349@udh.edu.pe" class="text-[#f53003] underline underline-offset-4 dark:text-[#FF4433]">2021110349@udh.edu.pe</a>
                            </p>
                        </div>
